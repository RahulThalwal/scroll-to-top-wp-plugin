...
class scroll_To_Top {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      scroll_To_Top_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - scroll_To_Top_Loader. Orchestrates the hooks of the plugin.
	 * - scroll_To_Top_i18n. Defines internationalization functionality.
	 * - scroll_To_Top_Admin. Defines all hooks for the admin area.
	 * - scroll_To_Top_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the scroll_To_Top_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action('wp_footer', $plugin_public, 'display_scroll_button');
	 ...
	 *
	 * @since     1.0.0
	 * @return    scroll_To_Top_Loader    Orchestrates the hooks of the plugin.
	 */
